...
public class XssMvcApiDetector extends AbstractTaintDetector {
    ...
    // TODO : Avoid checking every single class
    /*@Override
    public boolean shouldAnalyzeClass(ClassContext classContext) {
        //The class extends the play controller base class
        return InterfaceUtils.isSubtype(classContext.getJavaClass(), "play.api.mvc.Controller");
    }*/
}
